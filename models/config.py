...
class GANReplayConfig:
    ...
    dataset_name: str = "mnist"  # Dataset name for architecture selection
    num_total_classes: int = 10  # global label space size
...
class ACGANConfig:
    ...
    dataset_name: str = "mnist"  # Dataset name for architecture selection
    num_total_classes: int = 10  # Total classes in dataset